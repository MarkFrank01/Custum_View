 ...
 * Package_NAME : com.wjc.learn.view.test_view.sample.bezier
 * File_NAME : bsrLearn
 * Created by WJC on 2017/11/25 10:39
 * Describe : TODO
 */

public class bsrLearn extends View {
    ...
    public bsrLearn(Context context) {
        this(context, null);
    }

    public bsrLearn(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
